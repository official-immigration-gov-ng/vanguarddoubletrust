...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Statement of Account - VanguardDoubleTrust</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <meta content="Combined history of your transactions and transfers." name="description" />
    ...
    <style>
      ...
      .st-table tbody tr td:first-child {
        border-left: 1px solid rgba(15, 23, 42, 0.08);
      }

      .st-table tbody tr td:last-child {
  ...
  <body>
    ...
    <div class="vt-shell" id="statementRoot">
      <aside class="vt-sidebar">
        ...
        <nav class="vt-nav">
          ...
          <a class="active" href="/customer/statement.php">
      ...
      <main class="vt-main">
        <header class="vt-topbar">
          ...
          <div class="vt-user">
            ...
            <div class="meta">
              <strong id="statementUserName">Loading...</strong>
              <span id="statementUserEmail"> </span>
            </div>
          </div>
        </header>
        ...
        <div class="vt-content">
          <div class="vt-page-title">
            ...
            <p>Combined history of your transactions and transfers.</p>
          </div>
          ...
          <section class="st-wrap">
            ...
            <div class="st-stats">
              <div class="st-stat">
                ...
                <div class="v" id="stAccountHolder">--</div>
              </div>
              <div class="st-stat">
                <div class="k">ACCOUNT NUMBER</div>
                <div class="v" id="stAccountNumber">--</div>
              </div>
              <div class="st-stat">
                <div class="k">CURRENT BALANCE</div>
                <div class="v" id="stCurrentBalance">$0.00</div>
              </div>
            </div>
            ...
            <div class="st-body">
              ...
              <div class="st-foot">
                <div id="stInfo">Showing 0 to 0 of 0 entries</div>
                <div id="stPager"></div>
              </div>
            </div>
          </section>
